<header class="sticky top-0 z-30 safe-top bg-blue-600 text-white shadow-md">
    <div class="px-4 py-3 flex items-center justify-between" x-data="{ isMenuOpen: false }">
        ...
        <div x-show="isMenuOpen" 
            ...
            <!-- Menu items -->
            <nav class="py-2">
                <a href="{{ route('dashboard') }}" class="block px-4 py-3 hover:bg-blue-50 flex items-center">
                ...
                <a href="{{ route('cashier') }}" class="block px-4 py-3 hover:bg-blue-50 flex items-center">
                    <svg class="h-5 w-5 mr-3 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                    </svg>
                    Cashier
                </a>
                <a href="{{ route('products.index') }}" class="block px-4 py-3 hover:bg-blue-50 flex items-center">
                    <svg class="h-5 w-5 mr-3 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                    </svg>
                    Products
                </a>
                <a href="{{ route('categories.index') }}" class="block px-4 py-3 hover:bg-blue-50 flex items-center">
                    <svg class="h-5 w-5 mr-3 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                    </svg>
                    Categories
                </a>
                <a href="{{ route('transactions.index') }}" class="block px-4 py-3 hover:bg-blue-50 flex items-center">
                    <svg class="h-5 w-5 mr-3 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                    </svg>
                    Transactions
                </a>
                <a href="{{ route('stock.index') }}" class="block px-4 py-3 hover:bg-blue-50 flex items-center">
                    <svg class="h-5 w-5 mr-3 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4"></path>
                    </svg>
                    Stock
                </a>
                <a href="{{ route('reports.sales') }}" class="block px-4 py-3 hover:bg-blue-50 flex items-center">
                    <svg class="h-5 w-5 mr-3 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="block w-full text-left px-4 py-3 hover:bg-blue-50 flex items-center text-red-600">
